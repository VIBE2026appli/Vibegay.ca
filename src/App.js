...
export default function App() {
  return (
    <div style={{
      ...
      {/* Glow blobs */}
      {/* ⚡ Bolt: Added transform: translateZ(0) and willChange: transform to force these heavy blur filters onto a separate GPU layer, preventing main thread repaint lag */}
      <div style={{
